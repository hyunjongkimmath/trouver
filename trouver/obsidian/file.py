# AUTOGENERATED! DO NOT EDIT! File to edit: ../../nbs/03_obsidian_40.file.ipynb.

# %% ../../nbs/03_obsidian_40.file.ipynb #0f4dcc8b
...
from .vault import VaultNote, NoteDoesNotExistError, NotePathIsNotIdentifiedError
from trouver.obsidian.tags import (
    strip_auto_from_tag, tag_is_auto_tag
)

# %% auto #0
__all__ = ['find_front_matter_meta_in_markdown_text', 'dict_to_metadata_lines', 'parse_metadata_string', 'replace_embedded_links_with_text', 'MarkdownLineEnum', 'MarkdownFile']

# %% ../../nbs/03_obsidian_40.file.ipynb #a9c96635
...
# %% ../../nbs/03_obsidian_40.file.ipynb #edf03c4c
def _enquote(text):
    return f'"{text}"'
...
# %% ../../nbs/03_obsidian_40.file.ipynb #fec83a5b
...
# %% ../../nbs/03_obsidian_40.file.ipynb #a05e0a89
...
# %% ../../nbs/03_obsidian_40.file.ipynb #dae23c77
...
# %% ../../nbs/03_obsidian_40.file.ipynb #fbfb544d
...
# %% ../../nbs/03_obsidian_40.file.ipynb #27303c8f
class MarkdownFile:
    r"""
...
# %% ../../nbs/03_obsidian_40.file.ipynb #85f88738
...
# %% ../../nbs/03_obsidian_40.file.ipynb #563b145b
@patch(cls_method=True)
def parts_from_list(
        cls: MarkdownFile,
        list_of_lines: list[str],
...
# %% ../../nbs/03_obsidian_40.file.ipynb #bcaa5fb4
@patch(cls_method=True)
def parts_from_text(
        cls: MarkdownFile,
        text: str,
...
# %% ../../nbs/03_obsidian_40.file.ipynb #67e0aa46
@patch(cls_method=True)
def from_list(
        cls: MarkdownFile,
        list_of_lines: list[str],
...
# %% ../../nbs/03_obsidian_40.file.ipynb #fc5dbc6c
@patch(cls_method=True)
def from_vault_note(
        cls: MarkdownFile,
...
# %% ../../nbs/03_obsidian_40.file.ipynb #7f23730f
@patch(cls_method=True)
def from_file(
        cls: MarkdownFile,
        file_path: PathLike
...
# %% ../../nbs/03_obsidian_40.file.ipynb #62b5a69c
@patch
def text_of_lines(
        self: MarkdownFile,
        start: int,
...
# %% ../../nbs/03_obsidian_40.file.ipynb #66d9171a
@patch(cls_method=True)
def from_string(
        cls: MarkdownFile,
...
# %% ../../nbs/03_obsidian_40.file.ipynb #a52eadaf
@patch
...
# %% ../../nbs/03_obsidian_40.file.ipynb #3db1f5fa
@patch
def get_headings(
        self: MarkdownFile,
    ...
    """
    Return a list of heading titles in the markdown file, in the order that they appear.
    """
    line_dict: dict[int, str] = self.get_headings_by_line_number(
        levels, include_start=include_start)
    return [value for key, value in sorted(line_dict.items())]
    # return list(line_dict.values())

# %% ../../nbs/03_obsidian_40.file.ipynb #2b7add6b
@patch
...
# %% ../../nbs/03_obsidian_40.file.ipynb #0c5ed0e1
@patch
...
# %% ../../nbs/03_obsidian_40.file.ipynb #463bb709
@patch
...
# %% ../../nbs/03_obsidian_40.file.ipynb #6cb6f41b
@patch
def get_line_numbers_under_heading(
        ...
        ) -> Union[tuple[int], Literal[-1]]: # `(start, end)` where `self.parts[start:end]` represents the parts under the heading, including the start of the heading.  If the heading of the specified title does not exist, then returns -1.
    """
...
# %% ../../nbs/03_obsidian_40.file.ipynb #cb66cb80
@patch
def insert_line(
        self: MarkdownFile,
...
# %% ../../nbs/03_obsidian_40.file.ipynb #62cbd59f
@patch
def remove_line(
        self: MarkdownFile,
...
# %% ../../nbs/03_obsidian_40.file.ipynb #5a90243f
@patch
def remove_lines(
        self: MarkdownFile,
...
# %% ../../nbs/03_obsidian_40.file.ipynb #b46e2c0f
@patch
def pop_line(
        self: MarkdownFile,
...
# %% ../../nbs/03_obsidian_40.file.ipynb #6053ef53
@patch
def add_line_to_end(
        self: MarkdownFile,
        line_dict: dict[str, Union[MarkdownLineEnum, str]] # See `self.parts`.
...
# %% ../../nbs/03_obsidian_40.file.ipynb #30d7e183
@patch
...
# %% ../../nbs/03_obsidian_40.file.ipynb #5ea71a38
@patch
...
# %% ../../nbs/03_obsidian_40.file.ipynb #78f452ee
@patch
def reset_parts(
        self: MarkdownFile,
    ) -> None:
...
# %% ../../nbs/03_obsidian_40.file.ipynb #6bbcb8e4
@patch
def remove_section(
        self: MarkdownFile,
...
# %% ../../nbs/03_obsidian_40.file.ipynb #ca2d5e6b
@patch
def clear_section(
        self: MarkdownFile,
...
# %% ../../nbs/03_obsidian_40.file.ipynb #d3a158ec
@patch
...
# %% ../../nbs/03_obsidian_40.file.ipynb #8c37e70d
@patch
def metadata(
        self: MarkdownFile
...
# %% ../../nbs/03_obsidian_40.file.ipynb #8325d0f5
@patch
def metadata_parts(
        self: MarkdownFile
...
# %% ../../nbs/03_obsidian_40.file.ipynb #84541239
@patch
def has_metadata(
...
# %% ../../nbs/03_obsidian_40.file.ipynb #a62b3c68
@patch
def metadata_lines(
        self: MarkdownFile
...
# %% ../../nbs/03_obsidian_40.file.ipynb #216c12f7
@patch
...
# %% ../../nbs/03_obsidian_40.file.ipynb #562a3a3d
@patch
def remove_metadata(
    self: MarkdownFile) -> None:
...
# %% ../../nbs/03_obsidian_40.file.ipynb #b80312e1
@patch
...
# %% ../../nbs/03_obsidian_40.file.ipynb #4efdfc31
@patch
def tags(
        self: MarkdownFile
        ) -> set[str] | None:
...
# %% ../../nbs/03_obsidian_40.file.ipynb #a3c347e3
@patch
def has_tag(
        self: MarkdownFile,
...
# %% ../../nbs/03_obsidian_40.file.ipynb #5e50eb81
@patch
def add_tags(
        self: MarkdownFile,
...
# %% ../../nbs/03_obsidian_40.file.ipynb #9d89314f
@patch
def remove_tags(
        self: MarkdownFile,
...
# %% ../../nbs/03_obsidian_40.file.ipynb #fe57be8f
@patch
...
# %% ../../nbs/03_obsidian_40.file.ipynb #e1e24f5f
@patch
...
# %% ../../nbs/03_obsidian_40.file.ipynb #a6689ab8
@patch
...
# %% ../../nbs/03_obsidian_40.file.ipynb #effd81b0
@patch
...
# %% ../../nbs/03_obsidian_40.file.ipynb #23edb2e0
@patch
...
# %% ../../nbs/03_obsidian_40.file.ipynb #a6ed70e9
@patch
def remove_headers(
        self: MarkdownFile) -> None:
    """Remove all headers."""
...
# %% ../../nbs/03_obsidian_40.file.ipynb #73b07e84
@patch
...
# %% ../../nbs/03_obsidian_40.file.ipynb #6141645a
@patch
...
def _text_of_embedded_link_of_section(
        ...
        remove_paragraph_id: bool) -> str:
    """Used in `_replace_embedded_links_one_line"""
    line_nums_under_heading = link_file.get_line_numbers_under_heading(
        title=heading, include_subheadings=True)
    if line_nums_under_heading == -1:
        return ''
    start, end = line_nums_under_heading
...
# %% ../../nbs/03_obsidian_40.file.ipynb #0a5dafcd
@patch
...
# %% ../../nbs/03_obsidian_40.file.ipynb #a3e5a7dc
@patch
def replace_embedded_links_with_text(
        self: MarkdownFile,
        vault: PathLike,
...
# %% ../../nbs/03_obsidian_40.file.ipynb #c1570b48
@patch
...
# %% ../../nbs/03_obsidian_40.file.ipynb #a3de9a3f
@patch
def parts_of_id(
            self: MarkdownFile,
...
# %% ../../nbs/03_obsidian_40.file.ipynb #e65fa5da
@patch
...
# %% ../../nbs/03_obsidian_40.file.ipynb #ac782efb
@patch
...
# %% ../../nbs/03_obsidian_40.file.ipynb #2df021b0
@patch
...
# %% ../../nbs/03_obsidian_40.file.ipynb #a4bbf0fe
@patch
...
# %% ../../nbs/03_obsidian_40.file.ipynb #5694c396
@patch
...
# %% ../../nbs/03_obsidian_40.file.ipynb #2a0f72d8
@patch
...
# %% ../../nbs/03_obsidian_40.file.ipynb #3889b545
@patch
...
# %% ../../nbs/03_obsidian_40.file.ipynb #d9e03963
@patch
...
# %% ../../nbs/03_obsidian_40.file.ipynb #62be3d17
@patch
...
# %% ../../nbs/03_obsidian_49.file_write.ipynb #c8291b33
@patch
def write(
    self: MarkdownFile,
