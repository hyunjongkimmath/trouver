...
# %% ../../nbs/03_obsidian_40.file.ipynb 3
...
# %% ../../nbs/03_obsidian_40.file.ipynb 6
...
# %% ../../nbs/03_obsidian_40.file.ipynb 12
def _enquote(text):
    return f'"{text}"'
...
# %% ../../nbs/03_obsidian_40.file.ipynb 14
...
# %% ../../nbs/03_obsidian_40.file.ipynb 21
...
# %% ../../nbs/03_obsidian_40.file.ipynb 33
...
# %% ../../nbs/03_obsidian_40.file.ipynb 35
...
# %% ../../nbs/03_obsidian_40.file.ipynb 39
class MarkdownFile:
    r"""
...
# %% ../../nbs/03_obsidian_40.file.ipynb 50
...
# %% ../../nbs/03_obsidian_40.file.ipynb 51
@patch(cls_method=True)
def parts_from_list(
        cls: MarkdownFile,
        list_of_lines: list[str],
...
# %% ../../nbs/03_obsidian_40.file.ipynb 54
@patch(cls_method=True)
def parts_from_text(
        cls: MarkdownFile,
        text: str,
...
# %% ../../nbs/03_obsidian_40.file.ipynb 57
@patch(cls_method=True)
def from_list(
        cls: MarkdownFile,
        list_of_lines: list[str],
...
# %% ../../nbs/03_obsidian_40.file.ipynb 59
@patch(cls_method=True)
def from_vault_note(
        cls: MarkdownFile,
...
# %% ../../nbs/03_obsidian_40.file.ipynb 61
@patch(cls_method=True)
def from_file(
        cls: MarkdownFile,
        file_path: PathLike
...
# %% ../../nbs/03_obsidian_40.file.ipynb 63
@patch
def text_of_lines(
        self: MarkdownFile,
        start: int,
...
# %% ../../nbs/03_obsidian_40.file.ipynb 65
@patch(cls_method=True)
def from_string(
        cls: MarkdownFile,
...
# %% ../../nbs/03_obsidian_40.file.ipynb 79
@patch
...
# %% ../../nbs/03_obsidian_40.file.ipynb 82
@patch
def get_headings(
        self: MarkdownFile,
...
# %% ../../nbs/03_obsidian_40.file.ipynb 94
@patch
...
# %% ../../nbs/03_obsidian_40.file.ipynb 100
@patch
...
# %% ../../nbs/03_obsidian_40.file.ipynb 103
@patch
...
# %% ../../nbs/03_obsidian_40.file.ipynb 113
@patch
...
# %% ../../nbs/03_obsidian_40.file.ipynb 120
@patch
def insert_line(
        self: MarkdownFile,
...
# %% ../../nbs/03_obsidian_40.file.ipynb 122
@patch
def remove_line(
        self: MarkdownFile,
...
# %% ../../nbs/03_obsidian_40.file.ipynb 124
@patch
def remove_lines(
        self: MarkdownFile,
...
# %% ../../nbs/03_obsidian_40.file.ipynb 126
@patch
def pop_line(
        self: MarkdownFile,
...
# %% ../../nbs/03_obsidian_40.file.ipynb 128
@patch
def add_line_to_end(
        self: MarkdownFile,
        line_dict: dict[str, Union[MarkdownLineEnum, str]] # See `self.parts`.
...
# %% ../../nbs/03_obsidian_40.file.ipynb 130
@patch
...
# %% ../../nbs/03_obsidian_40.file.ipynb 132
@patch
...
# %% ../../nbs/03_obsidian_40.file.ipynb 134
@patch
def reset_parts(
        self: MarkdownFile,
    ) -> None:
...
# %% ../../nbs/03_obsidian_40.file.ipynb 137
@patch
def remove_section(
        self: MarkdownFile,
...
# %% ../../nbs/03_obsidian_40.file.ipynb 143
@patch
def clear_section(
        self: MarkdownFile,
...
# %% ../../nbs/03_obsidian_40.file.ipynb 148
@patch
...
# %% ../../nbs/03_obsidian_40.file.ipynb 152
@patch
def metadata(
        self: MarkdownFile
...
# %% ../../nbs/03_obsidian_40.file.ipynb 154
@patch
def metadata_parts(
        self: MarkdownFile
...
# %% ../../nbs/03_obsidian_40.file.ipynb 155
@patch
def has_metadata(
...
# %% ../../nbs/03_obsidian_40.file.ipynb 157
@patch
def metadata_lines(
        self: MarkdownFile
...
# %% ../../nbs/03_obsidian_40.file.ipynb 159
@patch
...
# %% ../../nbs/03_obsidian_40.file.ipynb 162
@patch
def remove_metadata(
    self: MarkdownFile) -> None:
...
# %% ../../nbs/03_obsidian_40.file.ipynb 175
@patch
...
# %% ../../nbs/03_obsidian_40.file.ipynb 184
@patch
def tags(
        self: MarkdownFile
        ) -> set[str] | None:
...
# %% ../../nbs/03_obsidian_40.file.ipynb 186
@patch
def has_tag(
        self: MarkdownFile,
...
# %% ../../nbs/03_obsidian_40.file.ipynb 188
@patch
def add_tags(
        self: MarkdownFile,
...
# %% ../../nbs/03_obsidian_40.file.ipynb 190
@patch
def remove_tags(
        self: MarkdownFile,
...
# %% ../../nbs/03_obsidian_40.file.ipynb 197
@patch
...
# %% ../../nbs/03_obsidian_40.file.ipynb 203
@patch
...
# %% ../../nbs/03_obsidian_40.file.ipynb 209
@patch
...
# %% ../../nbs/03_obsidian_40.file.ipynb 214
@patch
...
# %% ../../nbs/03_obsidian_40.file.ipynb 217
@patch
...
# %% ../../nbs/03_obsidian_40.file.ipynb 224
@patch
def remove_headers(
        self: MarkdownFile) -> None:
    """Remove all headers."""
...
# %% ../../nbs/03_obsidian_40.file.ipynb 228
@patch
...
# %% ../../nbs/03_obsidian_40.file.ipynb 233
@patch
...
# %% ../../nbs/03_obsidian_40.file.ipynb 234
@patch
...
# %% ../../nbs/03_obsidian_40.file.ipynb 235
@patch
def replace_embedded_links_with_text(
        self: MarkdownFile,
        vault: PathLike,
...
# %% ../../nbs/03_obsidian_40.file.ipynb 237
@patch
...
# %% ../../nbs/03_obsidian_40.file.ipynb 238
@patch
def parts_of_id(
            self: MarkdownFile,
...
# %% ../../nbs/03_obsidian_40.file.ipynb 242
@patch
...
# %% ../../nbs/03_obsidian_40.file.ipynb 245
@patch
...
# %% ../../nbs/03_obsidian_40.file.ipynb 246
@patch
...
# %% ../../nbs/03_obsidian_40.file.ipynb 250
@patch
...
# %% ../../nbs/03_obsidian_40.file.ipynb 251
@patch
...
# %% ../../nbs/03_obsidian_40.file.ipynb 263
@patch
...
# %% ../../nbs/03_obsidian_40.file.ipynb 265
@patch
...
# %% ../../nbs/03_obsidian_40.file.ipynb 271
@patch
...
# %% ../../nbs/03_obsidian_40.file.ipynb 275
@patch
...
# %% ../../nbs/03_obsidian_49.file_write.ipynb 3
@patch
def write(
    self: MarkdownFile,
