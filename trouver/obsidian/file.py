...
# %% ../../nbs/03_obsidian_40.file.ipynb #f5fd8d52
...
# %% ../../nbs/03_obsidian_40.file.ipynb #43ebf44e
...
# %% ../../nbs/03_obsidian_40.file.ipynb #a02d9faf
def _enquote(text):
    return f'"{text}"'
...
# %% ../../nbs/03_obsidian_40.file.ipynb #af41db9c
...
# %% ../../nbs/03_obsidian_40.file.ipynb #483d878b
...
# %% ../../nbs/03_obsidian_40.file.ipynb #de526442
...
# %% ../../nbs/03_obsidian_40.file.ipynb #d1f84716
...
# %% ../../nbs/03_obsidian_40.file.ipynb #4c451841
class MarkdownFile:
    r"""
...
# %% ../../nbs/03_obsidian_40.file.ipynb #a1156415
...
# %% ../../nbs/03_obsidian_40.file.ipynb #03d3ae07
@patch(cls_method=True)
def parts_from_list(
        cls: MarkdownFile,
        list_of_lines: list[str],
...
# %% ../../nbs/03_obsidian_40.file.ipynb #c9c52b84
@patch(cls_method=True)
def parts_from_text(
        cls: MarkdownFile,
        text: str,
...
# %% ../../nbs/03_obsidian_40.file.ipynb #16f14a38
@patch(cls_method=True)
def from_list(
        cls: MarkdownFile,
        list_of_lines: list[str],
...
# %% ../../nbs/03_obsidian_40.file.ipynb #e78d4aa7
@patch(cls_method=True)
def from_vault_note(
        cls: MarkdownFile,
...
# %% ../../nbs/03_obsidian_40.file.ipynb #c52149af
@patch(cls_method=True)
def from_file(
        cls: MarkdownFile,
        file_path: PathLike
...
# %% ../../nbs/03_obsidian_40.file.ipynb #e9575dc5
@patch
def text_of_lines(
        self: MarkdownFile,
        start: int,
...
# %% ../../nbs/03_obsidian_40.file.ipynb #f1debc95
@patch(cls_method=True)
def from_string(
        cls: MarkdownFile,
...
# %% ../../nbs/03_obsidian_40.file.ipynb #066eb255
@patch
...
# %% ../../nbs/03_obsidian_40.file.ipynb #c6f9e871
@patch
def get_headings(
        self: MarkdownFile,
...
# %% ../../nbs/03_obsidian_40.file.ipynb #62399b26
@patch
...
# %% ../../nbs/03_obsidian_40.file.ipynb #541bd293
@patch
...
# %% ../../nbs/03_obsidian_40.file.ipynb #407b2dfa
@patch
...
# %% ../../nbs/03_obsidian_40.file.ipynb #c03d2023
@patch
...
# %% ../../nbs/03_obsidian_40.file.ipynb #72531f45
@patch
def insert_line(
        self: MarkdownFile,
...
# %% ../../nbs/03_obsidian_40.file.ipynb #71379220
@patch
def remove_line(
        self: MarkdownFile,
...
# %% ../../nbs/03_obsidian_40.file.ipynb #e9fac868
@patch
def remove_lines(
        self: MarkdownFile,
...
# %% ../../nbs/03_obsidian_40.file.ipynb #98b447cd
@patch
def pop_line(
        self: MarkdownFile,
...
# %% ../../nbs/03_obsidian_40.file.ipynb #9fac2f3a
@patch
def add_line_to_end(
        self: MarkdownFile,
        line_dict: dict[str, Union[MarkdownLineEnum, str]] # See `self.parts`.
...
# %% ../../nbs/03_obsidian_40.file.ipynb #6a137681
@patch
...
# %% ../../nbs/03_obsidian_40.file.ipynb #1f4a6f87
@patch
...
# %% ../../nbs/03_obsidian_40.file.ipynb #ce6a107f
@patch
def reset_parts(
        self: MarkdownFile,
    ) -> None:
...
# %% ../../nbs/03_obsidian_40.file.ipynb #322fc8c6
@patch
def remove_section(
        self: MarkdownFile,
...
# %% ../../nbs/03_obsidian_40.file.ipynb #f592af0e
@patch
def clear_section(
        self: MarkdownFile,
...
# %% ../../nbs/03_obsidian_40.file.ipynb #9037431a
@patch
...
# %% ../../nbs/03_obsidian_40.file.ipynb #7c953baf
@patch
def metadata(
        self: MarkdownFile
...
# %% ../../nbs/03_obsidian_40.file.ipynb #f4834b64
@patch
def metadata_parts(
        self: MarkdownFile
...
# %% ../../nbs/03_obsidian_40.file.ipynb #8a3f5c25
@patch
def has_metadata(
...
# %% ../../nbs/03_obsidian_40.file.ipynb #4be9bda8
@patch
def metadata_lines(
        self: MarkdownFile
...
# %% ../../nbs/03_obsidian_40.file.ipynb #710bf647
@patch
...
# %% ../../nbs/03_obsidian_40.file.ipynb #89447046
@patch
def remove_metadata(
    self: MarkdownFile) -> None:
...
# %% ../../nbs/03_obsidian_40.file.ipynb #9e95a965
@patch
...
# %% ../../nbs/03_obsidian_40.file.ipynb #68251c1b
@patch
def tags(
        self: MarkdownFile
        ) -> set[str] | None:
...
# %% ../../nbs/03_obsidian_40.file.ipynb #94a7be45
@patch
def has_tag(
        self: MarkdownFile,
...
# %% ../../nbs/03_obsidian_40.file.ipynb #96825b5a
@patch
def add_tags(
        self: MarkdownFile,
...
# %% ../../nbs/03_obsidian_40.file.ipynb #19445eeb
@patch
def remove_tags(
        self: MarkdownFile,
...
# %% ../../nbs/03_obsidian_40.file.ipynb #88d2baaa
@patch
...
# %% ../../nbs/03_obsidian_40.file.ipynb #0032da38
@patch
...
# %% ../../nbs/03_obsidian_40.file.ipynb #a5cc134c
@patch
...
# %% ../../nbs/03_obsidian_40.file.ipynb #c75f26e1
@patch
...
# %% ../../nbs/03_obsidian_40.file.ipynb #54fd582a
@patch
...
# %% ../../nbs/03_obsidian_40.file.ipynb #1754f36c
@patch
def remove_headers(
        self: MarkdownFile) -> None:
    """Remove all headers."""
...
# %% ../../nbs/03_obsidian_40.file.ipynb #a41046ba
@patch
...
# %% ../../nbs/03_obsidian_40.file.ipynb #87a89828
@patch
...
# %% ../../nbs/03_obsidian_40.file.ipynb #c89a468a
@patch
...
# %% ../../nbs/03_obsidian_40.file.ipynb #772428be
@patch
def replace_embedded_links_with_text(
        self: MarkdownFile,
        vault: PathLike,
...
# %% ../../nbs/03_obsidian_40.file.ipynb #8cc02e77
@patch
...
# %% ../../nbs/03_obsidian_40.file.ipynb #04fb1f1c
@patch
def parts_of_id(
            self: MarkdownFile,
...
# %% ../../nbs/03_obsidian_40.file.ipynb #d9ce17c4
@patch
...
# %% ../../nbs/03_obsidian_40.file.ipynb #9a9fe831
@patch
...
# %% ../../nbs/03_obsidian_40.file.ipynb #325805fb
@patch
...
# %% ../../nbs/03_obsidian_40.file.ipynb #f34c26f7
@patch
...
# %% ../../nbs/03_obsidian_40.file.ipynb #6b1c5486
@patch
...
# %% ../../nbs/03_obsidian_40.file.ipynb #58a0f4e8
@patch
...
# %% ../../nbs/03_obsidian_40.file.ipynb #45ac0738
@patch
...
# %% ../../nbs/03_obsidian_40.file.ipynb #82a9f1a9
@patch
...
# %% ../../nbs/03_obsidian_40.file.ipynb #8e4d4707
@patch
