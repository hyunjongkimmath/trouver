...
# %% ../../nbs/03_obsidian_40.file.ipynb #81ee2611
...
# %% ../../nbs/03_obsidian_40.file.ipynb #07cbef73
...
# %% ../../nbs/03_obsidian_40.file.ipynb #dad38d12
def _enquote(text):
    return f'"{text}"'
...
# %% ../../nbs/03_obsidian_40.file.ipynb #259dbfe2
...
# %% ../../nbs/03_obsidian_40.file.ipynb #f78c1f6d
...
# %% ../../nbs/03_obsidian_40.file.ipynb #20443d3c
...
# %% ../../nbs/03_obsidian_40.file.ipynb #b8a6c10b
...
# %% ../../nbs/03_obsidian_40.file.ipynb #a551d934
class MarkdownFile:
    r"""
...
# %% ../../nbs/03_obsidian_40.file.ipynb #c89b27ae
...
# %% ../../nbs/03_obsidian_40.file.ipynb #5b721688
@patch(cls_method=True)
def parts_from_list(
        cls: MarkdownFile,
        list_of_lines: list[str],
...
# %% ../../nbs/03_obsidian_40.file.ipynb #5b2eb181
@patch(cls_method=True)
def parts_from_text(
        cls: MarkdownFile,
        text: str,
...
# %% ../../nbs/03_obsidian_40.file.ipynb #d61e21ea
@patch(cls_method=True)
def from_list(
        cls: MarkdownFile,
        list_of_lines: list[str],
...
# %% ../../nbs/03_obsidian_40.file.ipynb #59e7d856
@patch(cls_method=True)
def from_vault_note(
        cls: MarkdownFile,
...
# %% ../../nbs/03_obsidian_40.file.ipynb #1087d486
@patch(cls_method=True)
def from_file(
        cls: MarkdownFile,
        file_path: PathLike
...
# %% ../../nbs/03_obsidian_40.file.ipynb #8137cfc8
@patch
def text_of_lines(
        self: MarkdownFile,
        start: int,
...
# %% ../../nbs/03_obsidian_40.file.ipynb #89992aaf
@patch(cls_method=True)
def from_string(
        cls: MarkdownFile,
...
# %% ../../nbs/03_obsidian_40.file.ipynb #ff250ed0
@patch
...
# %% ../../nbs/03_obsidian_40.file.ipynb #8ff14baf
@patch
def get_headings(
        self: MarkdownFile,
...
# %% ../../nbs/03_obsidian_40.file.ipynb #54802c11
@patch
...
# %% ../../nbs/03_obsidian_40.file.ipynb #5ff9eb6f
@patch
...
# %% ../../nbs/03_obsidian_40.file.ipynb #206708ed
@patch
...
# %% ../../nbs/03_obsidian_40.file.ipynb #414285d6
@patch
...
# %% ../../nbs/03_obsidian_40.file.ipynb #bc858474
@patch
def insert_line(
        self: MarkdownFile,
...
# %% ../../nbs/03_obsidian_40.file.ipynb #a4a6948f
@patch
def remove_line(
        self: MarkdownFile,
...
# %% ../../nbs/03_obsidian_40.file.ipynb #51e20590
@patch
def remove_lines(
        self: MarkdownFile,
...
# %% ../../nbs/03_obsidian_40.file.ipynb #91e358cf
@patch
def pop_line(
        self: MarkdownFile,
...
# %% ../../nbs/03_obsidian_40.file.ipynb #69842de1
@patch
def add_line_to_end(
        self: MarkdownFile,
        line_dict: dict[str, Union[MarkdownLineEnum, str]] # See `self.parts`.
...
# %% ../../nbs/03_obsidian_40.file.ipynb #28897542
@patch
...
# %% ../../nbs/03_obsidian_40.file.ipynb #9369944e
@patch
...
# %% ../../nbs/03_obsidian_40.file.ipynb #2afc93e2
@patch
def reset_parts(
        self: MarkdownFile,
    ) -> None:
...
# %% ../../nbs/03_obsidian_40.file.ipynb #fa67cc91
@patch
def remove_section(
        self: MarkdownFile,
...
# %% ../../nbs/03_obsidian_40.file.ipynb #267885ab
@patch
def clear_section(
        self: MarkdownFile,
...
# %% ../../nbs/03_obsidian_40.file.ipynb #43c314bf
@patch
...
# %% ../../nbs/03_obsidian_40.file.ipynb #7fbc4762
@patch
def metadata(
        self: MarkdownFile
...
# %% ../../nbs/03_obsidian_40.file.ipynb #b5571a45
@patch
def metadata_parts(
        self: MarkdownFile
...
# %% ../../nbs/03_obsidian_40.file.ipynb #5ef8113c
@patch
def has_metadata(
...
# %% ../../nbs/03_obsidian_40.file.ipynb #408e85b1
@patch
def metadata_lines(
        self: MarkdownFile
...
# %% ../../nbs/03_obsidian_40.file.ipynb #49da2af8
@patch
...
# %% ../../nbs/03_obsidian_40.file.ipynb #2e3b3eb4
@patch
def remove_metadata(
    self: MarkdownFile) -> None:
...
# %% ../../nbs/03_obsidian_40.file.ipynb #7a0c58b5
@patch
...
# %% ../../nbs/03_obsidian_40.file.ipynb #1e79c995
@patch
def tags(
        self: MarkdownFile
        ) -> set[str] | None:
...
# %% ../../nbs/03_obsidian_40.file.ipynb #374eed76
@patch
def has_tag(
        self: MarkdownFile,
...
# %% ../../nbs/03_obsidian_40.file.ipynb #8a23e4f4
@patch
def add_tags(
        self: MarkdownFile,
...
# %% ../../nbs/03_obsidian_40.file.ipynb #5708bcbf
@patch
def remove_tags(
        self: MarkdownFile,
...
# %% ../../nbs/03_obsidian_40.file.ipynb #7e1e8f4d
@patch
...
# %% ../../nbs/03_obsidian_40.file.ipynb #6f221ab3
@patch
...
# %% ../../nbs/03_obsidian_40.file.ipynb #43d852df
@patch
...
# %% ../../nbs/03_obsidian_40.file.ipynb #cb985c67
@patch
...
# %% ../../nbs/03_obsidian_40.file.ipynb #b6ad5269
@patch
...
# %% ../../nbs/03_obsidian_40.file.ipynb #28582b13
@patch
def remove_headers(
        self: MarkdownFile) -> None:
    """Remove all headers."""
...
# %% ../../nbs/03_obsidian_40.file.ipynb #ee82eaca
@patch
...
# %% ../../nbs/03_obsidian_40.file.ipynb #b6ddaa56
@patch
...
# %% ../../nbs/03_obsidian_40.file.ipynb #3da73c0b
@patch
...
# %% ../../nbs/03_obsidian_40.file.ipynb #3650f668
@patch
def replace_embedded_links_with_text(
        self: MarkdownFile,
        vault: PathLike,
...
# %% ../../nbs/03_obsidian_40.file.ipynb #502074b8
@patch
...
# %% ../../nbs/03_obsidian_40.file.ipynb #cd1e8558
@patch
def parts_of_id(
            self: MarkdownFile,
...
# %% ../../nbs/03_obsidian_40.file.ipynb #f618bc57
@patch
...
# %% ../../nbs/03_obsidian_40.file.ipynb #7accc7c1
@patch
...
# %% ../../nbs/03_obsidian_40.file.ipynb #c257301d
@patch
...
# %% ../../nbs/03_obsidian_40.file.ipynb #8bd300ec
@patch
...
# %% ../../nbs/03_obsidian_40.file.ipynb #0ade60df
@patch
...
# %% ../../nbs/03_obsidian_40.file.ipynb #09d52b05
@patch
...
# %% ../../nbs/03_obsidian_40.file.ipynb #24cb98f4
@patch
...
# %% ../../nbs/03_obsidian_40.file.ipynb #f289d4c5
@patch
...
# %% ../../nbs/03_obsidian_40.file.ipynb #c543d6b5
@patch
