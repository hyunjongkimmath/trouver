# AUTOGENERATED! DO NOT EDIT! File to edit: ../../nbs/02_markdown_00.heading.ipynb.

# %% auto #0
__all__ = ['heading_level', 'heading_title']

# %% ../../nbs/02_markdown_00.heading.ipynb #f7b30726
def heading_level(
...
# %% ../../nbs/02_markdown_00.heading.ipynb #075bd912
def heading_title(
        heading_str: str # A str representing a markdown heading. Starts with 1 to 6 sharps `'#'`.
        ) -> str:
