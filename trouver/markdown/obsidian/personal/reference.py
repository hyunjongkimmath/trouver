...
# %% auto 0
__all__ = ['index_note_for_reference', 'reference_directory', 'copy_obsidian_vault_configs', 'setup_folder_for_new_reference']
...
def _make_template_file(
    ...
    template_note = VaultNote(vault, rel_path=template_file_path)
