...
# %% ../../nbs/46_helper.files_and_folders.ipynb 3
if sys.platform.startswith('win'):
    import winreg
else:
    winreg = None

# %% ../../nbs/46_helper.files_and_folders.ipynb 7
def existing_path(
...
# %% ../../nbs/46_helper.files_and_folders.ipynb 20
...
# %% ../../nbs/46_helper.files_and_folders.ipynb 27
def path_no_ext(
    path: PathLike # The path of the file or directory. This may be absolute or relative to any directory.
...
# %% ../../nbs/46_helper.files_and_folders.ipynb 31
def text_from_file(
...
# %% ../../nbs/46_helper.files_and_folders.ipynb 35
