...
# %% auto 0
__all__ = ['arxiv_search', 'extract_metadata', 'extract_last_names', 'folder_name_for_source', 'create_acronym',
...
def _download_pdf_with_name(
    ...
    if file_or_folder_name is not None:
        result.download_pdf(dir, filename=f'{file_or_folder_name}.pdf')
    else:
...
def _create_folder_for_source_download(
        ...
        ) -> PathLike: # The newly created folder 
    """
