# AUTOGENERATED! DO NOT EDIT! File to edit: ../../nbs/04_latex_15.formatting.ipynb.
...
# %% ../../nbs/04_latex_15.formatting.ipynb #cca7f500
import re
...
# %% ../../nbs/04_latex_15.formatting.ipynb #26ed05f0
def is_number(
...
# %% ../../nbs/04_latex_15.formatting.ipynb #5c7bbff3
...
# %% ../../nbs/04_latex_15.formatting.ipynb #b22ed582
...
# %% ../../nbs/04_latex_15.formatting.ipynb #9ff4370f
...
# %% ../../nbs/04_latex_15.formatting.ipynb #04006094
...
# %% ../../nbs/04_latex_15.formatting.ipynb #2229afc2
# EQUATION_LIKE_ENVS = []
...
# EQUATION_LIKE_ENVS = ["align", "displaymath", "equation", "eqnarray", "multline"]

EQUATION_LIKE_ENVS = [
    "align", "displaymath", "equation", "eqnarray",
...
def _replace_equationlike_envs(text: str):
    ...
    pattern = r'(\\begin\{(?:' + '|'.join(EQUATION_LIKE_ENVS) + r')\*?\})'
    text = re.sub(pattern, r'$$\1', text)
    
    pattern = r'(\\end\{(?:' + '|'.join(EQUATION_LIKE_ENVS) + r')\*?\})'
    text = re.sub(pattern, r'\1$$', text)
    return text
...
# %% ../../nbs/04_latex_15.formatting.ipynb #6409ccde
...
# %% ../../nbs/04_latex_15.formatting.ipynb #183ad5d7
...
# %% ../../nbs/04_latex_15.formatting.ipynb #49260d67
...
# %% ../../nbs/04_latex_15.formatting.ipynb #e29b3a65
...
# %% ../../nbs/04_latex_15.formatting.ipynb #a83a95c9
def _remove_xspace(
        text: str) -> str:
    r"""
...
# %% ../../nbs/04_latex_15.formatting.ipynb #b5688960
...
# %% ../../nbs/04_latex_15.formatting.ipynb #7ea765a0
...
# %% ../../nbs/04_latex_15.formatting.ipynb #10e2877e
...
# %% ../../nbs/04_latex_15.formatting.ipynb #b0acdeda
...
# %% ../../nbs/04_latex_15.formatting.ipynb #7420fcab
