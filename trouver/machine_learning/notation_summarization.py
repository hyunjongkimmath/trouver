# AUTOGENERATED! DO NOT EDIT! File to edit: ../../nbs/08_machine_learning_25.notation_summarization.ipynb.
...
__all__ = ['get_latex_in_original_from_parsed_notation_note_data', 'NotationSummaryData', 'notation_summarization_data_from_note',
           ...
           'append_to_notation_note_summarization_database', 'format_classical', 'format_training_tokens',
...
# %% ../../nbs/08_machine_learning_25.notation_summarization.ipynb #09272b4c
...
from ..notation.management import _notation_string_no_metadata, _raw_notation
...
# %% ../../nbs/08_machine_learning_25.notation_summarization.ipynb #b1dc2ee5
...
# %% ../../nbs/08_machine_learning_25.notation_summarization.ipynb #72bc3549
...
# %% ../../nbs/08_machine_learning_25.notation_summarization.ipynb #f7c89071
...
# %% ../../nbs/08_machine_learning_25.notation_summarization.ipynb #83546c94
...
# %% ../../nbs/08_machine_learning_25.notation_summarization.ipynb #a46bdf66
...
# %% ../../nbs/08_machine_learning_25.notation_summarization.ipynb #6c97d3d6
...
# %% ../../nbs/08_machine_learning_25.notation_summarization.ipynb #8b69fe3e
...
# %% ../../nbs/08_machine_learning_25.notation_summarization.ipynb #e6a7fb86
def format_classical(
        data: NotationSummaryData,
        latex_in_original_comes_first: bool = True
        ) -> str:
    """
    Formats input using the classical explicit label style.
    
    Structure: `latex_in_original: {latex}\\n\\n{main_text}` (or reversed).
    """
    main_text = data['processed_main_note_content']
    latex = data['latex_in_original']
    
    if latex_in_original_comes_first:
        return f"latex_in_original: {latex}\n\n{main_text}"
    else:
        return f"{main_text}\n\nlatex_in_original: {latex}"

# %% ../../nbs/08_machine_learning_25.notation_summarization.ipynb #49cf0af2
def format_training_tokens(
    ...
    """
    Formats input using special separation tokens, intended for training legacy T5/BART models.
    
    Structure: `latex_in_original: ... </s> notation: ... </s> main_text`
    """
    main_text = data['processed_main_note_content']
    latex = data['latex_in_original']
    ...
    parts = [
        f"latex_in_original: {latex}",
        f"notation: {notation}",
        main_text
    ]
    
    if not latex_in_original_comes_first:
        # Swap latex and notation if needed, or just append latex at end?
        # Preserving your original logic:
        return f"notation: {notation}\n\n{sep_token}\n\nlatex_in_original: {latex}\n\n{sep_token}\n\n{main_text}"
        
    return f"{parts[0]}\n\n{sep_token}\n\n{parts[1]}\n\n{sep_token}\n\n{parts[2]}"

# %% ../../nbs/08_machine_learning_25.notation_summarization.ipynb #5863d8b6
def format_for_gemma_instruct(data: NotationSummaryData) -> str:
    ...
    """
    main_text = data['processed_main_note_content']
    # Use the clean notation symbol
    target_symbol = data['notation'] 
    
    return f"Target: {target_symbol}\nText: {main_text}"

# %% ../../nbs/08_machine_learning_25.notation_summarization.ipynb #36a49734
def single_input_for_notation_summarization(
        ...
        **input_formatter_kwargs
        ) -> str:
    """
    Generates a formatted input string for notation summarization using a provided strategy.
    
    This function acts as a dispatcher to various formatting strategies.
    
    Args:
        notation_summary_data: Dictionary containing note content and metadata.
        input_formatter: A callable that accepts `NotationSummaryData` and returns a string.
                   Defaults to `format_training_tokens`.
        **input_formatter_kwargs: Keyword arguments passed directly to the `input_formatter`.
        
    Returns:
        str: The formatted string ready for model input.
    """
    return input_formatter(notation_summary_data, **input_formatter_kwargs)

# %% ../../nbs/08_machine_learning_25.notation_summarization.ipynb #2b7aa19d
...
# %% ../../nbs/08_machine_learning_25.notation_summarization.ipynb #f58f58d8
...
# %% ../../nbs/08_machine_learning_25.notation_summarization.ipynb #5f09536f
def summarize_notation(
        ...
        summarizer: Any, # Unfortunately, trying to type hint this causes problems. 
        ...
        **formatting_kwargs # Captures 'latex_first', 'sep_token', or even 'input_formatter'
        ) -> str:
    ...
    Any additional keyword arguments (like `latex_first=True`) are passed
    directly to the input formatting function.
...
# %% ../../nbs/08_machine_learning_25.notation_summarization.ipynb #25fd235d
...
# %% ../../nbs/08_machine_learning_25.notation_summarization.ipynb #b00a5c60
...
# %% ../../nbs/08_machine_learning_25.notation_summarization.ipynb #9d35f1c7
def _get_summary(
        metadata: dict[str],
        notation_str: str,
        main_mf: MarkdownFile,
        summarizer: Any, # pipelines.text2text_generation.SummarizationPipeline,
        # latex_in_original_comes_first: bool
        input_formatter: Callable[..., str],
        **formatter_kwargs # Captures 'latex_first', etc. 
        ) -> str:
    """
    This is a helper function of `append_summary_to_notation_note`.
...
# %% ../../nbs/08_machine_learning_25.notation_summarization.ipynb #18319370
...
# %% ../../nbs/08_machine_learning_25.notation_summarization.ipynb #bb52be35
def append_summary_to_notation_note(
        notation_note: VaultNote,
        vault: PathLike,
        summarizer: Any, #pipelines.text2text_generation.SummarizationPipeline, # Contains an ML model which summarizes the notation, see `summarize_notation` function.
    ...
    summary = _get_summary(
        metadata, notation_str, main_mf, summarizer,
        input_formatter=input_formatter, # Pass it down
        **input_formatter_kwargs
    )
