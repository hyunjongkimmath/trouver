...
# AUTOGENERATED! DO NOT EDIT! File to edit: ../../nbs/08_machine_learning_21.llm_notation_summarization.ipynb.

# %% auto 0
__all__ = ['NOTATION_SUMMARIZATION_SYSTEM_PROMPT', 'example_from_notation_note', 'notation_note_should_be_summarized',
           'generate_notation_summary', 'NotePairData', 'link_types_for_note_pair_data', 'sieve_note_data_pairs',
           'string_from_note_pair', 'augment_note_pair', 'NoteLinkingDataPoint', 'dict_data_point_from_pair',
           'dataset_from_note_data', 'MultiLabelPipeline', 'prediction_by_note_linking_model', 'predict_note_linking',
           'link_cache_note', 'separate_blocks', 'parse_link_cache_note', 'write_link_cache_note',
           'consolidate_note_linking_predictions_into_cache', 'consolidate_caches',
           'remove_blank_or_no_link_data_from_cache', 'remove_nonexistent_note_names_from_cache',
...
# %% ../../nbs/08_machine_learning_21.llm_notation_summarization.ipynb 3
...
# %% ../../nbs/08_machine_learning_21.llm_notation_summarization.ipynb 5
...
# %% ../../nbs/08_machine_learning_21.llm_notation_summarization.ipynb 6
...
# %% ../../nbs/08_machine_learning_21.llm_notation_summarization.ipynb 9
...
# %% ../../nbs/08_machine_learning_21.llm_notation_summarization.ipynb 12
...
# %% ../../nbs/08_machine_learning_21.llm_notation_summarization.ipynb 14
# # --- 2. CORE FUNCTIONS ---
...
#         excerpt_text: str,
#         target_symbol: str,
#         config: Optional[dict] = None, # Pass LM Studio / OpenAI style configs here
#         max_context: int = 4096,
#         verbose: bool = True,
#         return_thoughts: bool = False,
#         system_prompt: str = NOTATION_SUMMARIZATION_SYSTEM_PROMPT,
...
#     # Define safety defaults
#     merged_config = {
#         "temperature": 0.1,
#         "max_tokens": 1024,
#         "maxTokens": 1024,
#         "stop": ["<|im_end|>", "<|endoftext|>", "Text:", "Target:"] # Kill switches
#     }
    
#     # Override defaults with user-provided config if it exists
#     if config:
...
#     gen_limit = merged_config.get("max_tokens", 1024)
#     available_for_text = max_context - sys_tokens - safety_margin - target_overhead - gen_limit
...
#     try:
#         result = model.respond({"messages": messages}, config=merged_config)
...
# %% ../../nbs/08_machine_learning_21.llm_notation_summarization.ipynb 23
import ast
...
# %% ../../nbs/08_machine_learning_21.llm_notation_summarization.ipynb 27
class NotePairData(TypedDict):
    origin_note: NoteData
    relied_note: NoteData
    # linked_type: NoteLinkEnum

# %% ../../nbs/08_machine_learning_21.llm_notation_summarization.ipynb 28
...
# %% ../../nbs/08_machine_learning_21.llm_notation_summarization.ipynb 29
...
# %% ../../nbs/08_machine_learning_21.llm_notation_summarization.ipynb 30
...
# %% ../../nbs/08_machine_learning_21.llm_notation_summarization.ipynb 31
...
# %% ../../nbs/08_machine_learning_21.llm_notation_summarization.ipynb 32
...
# %% ../../nbs/08_machine_learning_21.llm_notation_summarization.ipynb 33
...
# %% ../../nbs/08_machine_learning_21.llm_notation_summarization.ipynb 34
...
# %% ../../nbs/08_machine_learning_21.llm_notation_summarization.ipynb 36
...
# %% ../../nbs/08_machine_learning_21.llm_notation_summarization.ipynb 37
...
# %% ../../nbs/08_machine_learning_21.llm_notation_summarization.ipynb 44
...
# %% ../../nbs/08_machine_learning_21.llm_notation_summarization.ipynb 49
...
# %% ../../nbs/08_machine_learning_21.llm_notation_summarization.ipynb 50
...
# %% ../../nbs/08_machine_learning_21.llm_notation_summarization.ipynb 52
...
# %% ../../nbs/08_machine_learning_21.llm_notation_summarization.ipynb 56
...
# %% ../../nbs/08_machine_learning_21.llm_notation_summarization.ipynb 57
...
# %% ../../nbs/08_machine_learning_21.llm_notation_summarization.ipynb 60
...
# %% ../../nbs/08_machine_learning_21.llm_notation_summarization.ipynb 64
def link_cache_note(
        vault: PathLike,
        reference: str,
...
# %% ../../nbs/08_machine_learning_21.llm_notation_summarization.ipynb 66
def separate_blocks(
        text: str) -> list[str]:
    """
...
# %% ../../nbs/08_machine_learning_21.llm_notation_summarization.ipynb 68
...
# %% ../../nbs/08_machine_learning_21.llm_notation_summarization.ipynb 70
...
# %% ../../nbs/08_machine_learning_21.llm_notation_summarization.ipynb 72
...
# %% ../../nbs/08_machine_learning_21.llm_notation_summarization.ipynb 74
...
# %% ../../nbs/08_machine_learning_21.llm_notation_summarization.ipynb 77
...
# %% ../../nbs/08_machine_learning_21.llm_notation_summarization.ipynb 79
...
# %% ../../nbs/08_machine_learning_21.llm_notation_summarization.ipynb 82
...
# %% ../../nbs/08_machine_learning_21.llm_notation_summarization.ipynb 83
...
# %% ../../nbs/08_machine_learning_21.llm_notation_summarization.ipynb 84
...
# %% ../../nbs/08_machine_learning_21.llm_notation_summarization.ipynb 86
...
# %% ../../nbs/08_machine_learning_21.llm_notation_summarization.ipynb 88
...
# %% ../../nbs/08_machine_learning_21.llm_notation_summarization.ipynb 91
...
# %% ../../nbs/08_machine_learning_21.llm_notation_summarization.ipynb 92
...
# %% ../../nbs/08_machine_learning_21.llm_notation_summarization.ipynb 94
...
# %% ../../nbs/08_machine_learning_21.llm_notation_summarization.ipynb 99
class SummarizationDataPoint(TypedDict):
    input: str
    output: str
    notat_note_name: str

# %% ../../nbs/08_machine_learning_21.llm_notation_summarization.ipynb 100
...
# %% ../../nbs/08_machine_learning_21.llm_notation_summarization.ipynb 101
...
# %% ../../nbs/08_machine_learning_21.llm_notation_summarization.ipynb 102
...
# %% ../../nbs/08_machine_learning_21.llm_notation_summarization.ipynb 105
...
# %% ../../nbs/08_machine_learning_21.llm_notation_summarization.ipynb 106
