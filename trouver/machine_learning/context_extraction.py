"""For using LLM's to extract context"""

# AUTOGENERATED! DO NOT EDIT! File to edit: ../../nbs/07_machine_learning_50.context_extraction.ipynb.
...
# %% ../../nbs/07_machine_learning_50.context_extraction.ipynb 2
...
# %% ../../nbs/07_machine_learning_50.context_extraction.ipynb 3
...
# %% ../../nbs/07_machine_learning_50.context_extraction.ipynb 5
...
# %% ../../nbs/07_machine_learning_50.context_extraction.ipynb 6
import re
...
# %% ../../nbs/07_machine_learning_50.context_extraction.ipynb 7
...
# %% ../../nbs/07_machine_learning_50.context_extraction.ipynb 8
...
#     This function is incremental and context-aware. It iterates through the 
#     associated notes in order, maintaining a running history of 'Previous Context'
#     to feed into the LLM for the next note.
#     """
#     # 1. Resolve the Master List (File Structure)
#     all_associated_notes = _resolve_info_notes_for_index(index_note)
    
#     # 2. Determine the Work Queue (Notes to actually process)
...
#     # --- FIX: Initialize current_data before the loop ---
...
#             # Run Prediction
#             # Note: Ensure extract_context_with_lm is compatible with your LLM object
#             context_info = extract_context_with_lm(model, llm_input)
            
#             if context_info:
#                 # Update Data
#                 current_data[note.name] = context_info
                
#                 # Add to running context for next iteration
#                 accumulated_context_list.append(context_info)
...
#         else:
#             # We are skipping this note (either not in target list, or already exists)
#             # BUT we must add its content to the accumulated context so future notes see it.
#             if note.name in current_data:
#                 accumulated_context_list.append(current_data[note.name])

#     print(f"Context extraction completed: {context_note.name}")


# %% ../../nbs/07_machine_learning_50.context_extraction.ipynb 9
import re
...
# %% ../../nbs/07_machine_learning_50.context_extraction.ipynb 11
