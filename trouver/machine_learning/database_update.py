...
# %% ../../nbs/08_machine_learning_05.database_update.ipynb 3
import os
...
# %% ../../nbs/08_machine_learning_05.database_update.ipynb 5
def max_ID(df: pd.DataFrame):
    "Return the largest value of `ID` in `df`"
    return df['ID'].to_numpy().max()

# %% ../../nbs/08_machine_learning_05.database_update.ipynb 7
