# AUTOGENERATED! DO NOT EDIT! File to edit: ../../nbs/08_machine_learning_05.database_update.ipynb.

# %% auto #0
__all__ = ['max_ID', 'append_to_database']

# %% ../../nbs/08_machine_learning_05.database_update.ipynb #240bfeae
import os
...
# %% ../../nbs/08_machine_learning_05.database_update.ipynb #28be6bfd
def max_ID(df: pd.DataFrame):
    "Return the largest value of `ID` in `df`"
    return df['ID'].to_numpy().max()

# %% ../../nbs/08_machine_learning_05.database_update.ipynb #0e54402f
