# AUTOGENERATED! DO NOT EDIT! File to edit: ../../nbs/05_personal_vault_15.reference.ipynb.

# %% auto #0
__all__ = ['index_note_for_reference', 'reference_directory', 'all_paths_to_notes_in_reference_folder', 'delete_reference_folder',
           'copy_obsidian_vault_configs', 'get_obsidian_vault_plugin_configs', 'modify_obsidian_vault_plugin_configs',
...
# %% ../../nbs/05_personal_vault_15.reference.ipynb #3e9d87e9
import glob
import itertools
import json
import os
...
from trouver.personal_vault.index_notes import ( 
...
# %% ../../nbs/05_personal_vault_15.reference.ipynb #18bede26
def index_note_for_reference(
        vault: PathLike, # The vault in which the reference folder resides.
        reference: Union[PathLike], # - The reference. Is either - a str, in which case the reference folder will be the folder containing the (unique) note of the name `_index_{reference}.md`, - or a `Path` object (not just a pathlike!) relative to `vault`, in which case the path will be the path to the reference folder. 
        update_cache: bool = False, # Whether or not to update the `VaultNote` class' cache. 
        ) -> VaultNote:
    """
...
# %% ../../nbs/05_personal_vault_15.reference.ipynb #597b6b85
def reference_directory(
        vault: PathLike, # The vault in which the reference folder resides.
        reference: PathLike, # - The reference. Is either - a str, in which case the reference folder will be the folder containing the (unique) note of the name `_index_{reference}.md`, - or a `Path` object (not just a pathlike!) relative to `vault`, in which case the path will be the path to the reference folder. 
...
# %% ../../nbs/05_personal_vault_15.reference.ipynb #ffa35a72
def all_paths_to_notes_in_reference_folder(
        vault: PathLike, # The path to the Obsidian vault directory
        reference: str,
        as_dict: bool = False # If `True`, then returns a dict. If `False`, then returns a list. Defaults to `False`. If there are multiple notes with the same name in the vault, and if `as_dict` is set to `True`, then the dictionary will contain a list of the (relative) paths (as str) to those notes.
        ) -> Union[list[str], dict[str, list[str]]]: # Each str represents the path relative to `vault`. If `as_dict` is True, then returns a dict whose keys are str, which are (unique) names of the notes in the vault, and the values are the paths.
    """Return the paths, relative to the Obsidian vault, of notes 
    in the reference folder of the Obsidian vault.
       
    See also `all_paths_to_notes_in_vault` in `04_markdown.file`.
    """
    vault = Path(vault)
    ref_dir = reference_directory(vault, reference)
    return md_files_in_dir(dir=vault/ref_dir, root=vault, as_dict=as_dict)
    # paths =  [os.path.relpath(path, vault) for path in (vault / ref_dir).glob(f'**/*.md')]
    # if as_dict:
...
# %% ../../nbs/05_personal_vault_15.reference.ipynb #3a5f2554
...
# %% ../../nbs/05_personal_vault_15.reference.ipynb #45decce6
...
# %% ../../nbs/05_personal_vault_15.reference.ipynb #ac5df834
...
# %% ../../nbs/05_personal_vault_15.reference.ipynb #f66bc047
...
# %% ../../nbs/05_personal_vault_15.reference.ipynb #7a9c29c5
...
# %% ../../nbs/05_personal_vault_15.reference.ipynb #6b5ab62c
...
# %% ../../nbs/05_personal_vault_15.reference.ipynb #e61e66e6
...
# %% ../../nbs/05_personal_vault_15.reference.ipynb #87a6654b
...
# %% ../../nbs/05_personal_vault_15.reference.ipynb #c6bc79ca
...
# %% ../../nbs/05_personal_vault_15.reference.ipynb #a9300029
...
# %% ../../nbs/05_personal_vault_15.reference.ipynb #d325f8da
...
# %% ../../nbs/05_personal_vault_15.reference.ipynb #eb2af9c6
...
# %% ../../nbs/05_personal_vault_15.reference.ipynb #dea811a2
...
# %% ../../nbs/05_personal_vault_15.reference.ipynb #9dfc8c67
...
# %% ../../nbs/05_personal_vault_15.reference.ipynb #809ff049
...
# %% ../../nbs/05_personal_vault_15.reference.ipynb #e8b085c2
...
# %% ../../nbs/05_personal_vault_15.reference.ipynb #5efe2ca8
...
# %% ../../nbs/05_personal_vault_15.reference.ipynb #a8019da8
...
# %% ../../nbs/05_personal_vault_15.reference.ipynb #ce1e10ec
...
# %% ../../nbs/05_personal_vault_15.reference.ipynb #7b30ee73
# TODO: reformat
...
# %% ../../nbs/05_personal_vault_15.reference.ipynb #d8c0fadd
...
# %% ../../nbs/05_personal_vault_15.reference.ipynb #ca314c49
# TODO: reformat
def files_in_reference_folder(
    ...
    **Parameters**
    ...
    - exclude_notes_of_type - list of 
            ``personal_vault.note_type.PersonalNoteTypeEnum``.
