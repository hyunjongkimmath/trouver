# AUTOGENERATED! DO NOT EDIT! File to edit: ../../nbs/05_personal_vault_05.index_notes.ipynb.
...
# %% ../../nbs/05_personal_vault_05.index_notes.ipynb #c0a3a32d
import glob
import os
...
# %% ../../nbs/05_personal_vault_05.index_notes.ipynb #b137eed6
...
# %% ../../nbs/05_personal_vault_05.index_notes.ipynb #d32342eb
...
# %% ../../nbs/05_personal_vault_05.index_notes.ipynb #d9d8182a
...
# %% ../../nbs/05_personal_vault_05.index_notes.ipynb #6955c209
    ...
    **Returns**
    ...
    if headings[0] == '':
        correspond_dict = {get_alphanumeric(heading, 'heading'): (heading, folder)
                       for heading, folder in zip(headings[1:], folders)}
    else:
        correspond_dict = {get_alphanumeric(heading, 'heading'): (heading, folder)
    ...
    if (include_non_heading and headings[0] == ''):
...
# %% ../../nbs/05_personal_vault_05.index_notes.ipynb #aaeecd87
def information_notes_linked_in_index_note(
    ...
    headings_folders: dict[str, str] = correspond_headings_with_folder(
        index_note, vault)
    mf = MarkdownFile.from_vault_note(index_note)
    headings_text: dict[str, str] = mf.get_headings_and_text(levels=1, include_start=True)
...
# %% ../../nbs/05_personal_vault_05.index_notes.ipynb #cad0d35b
...
# %% ../../nbs/05_personal_vault_05.index_notes.ipynb #058a5f3d
...
# %% ../../nbs/05_personal_vault_05.index_notes.ipynb #5d0a1c16
...
# %% ../../nbs/05_personal_vault_05.index_notes.ipynb #7113f831
...
# %% ../../nbs/05_personal_vault_05.index_notes.ipynb #5e9a1ec6
...
# %% ../../nbs/05_personal_vault_05.index_notes.ipynb #2a98de6d
...
# %% ../../nbs/05_personal_vault_05.index_notes.ipynb #9b0e6d49
