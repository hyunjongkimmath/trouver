...
// main.ts
__export(exports, {
  default: () => FastToggleTag
});
var import_obsidian = __toModule(require("obsidian"));
var yaml = require_js_yaml();
var FastToggleTag = class extends import_obsidian.Plugin {
  onload() {
...
function findTagsMetaInText(text) {
  if (!textHasMeta(text)) {
    return -1;
  }
...
function toggleMetaTag(app, tag, toggle_auto_tag = true) {
  return __async(this, null, function* () {
