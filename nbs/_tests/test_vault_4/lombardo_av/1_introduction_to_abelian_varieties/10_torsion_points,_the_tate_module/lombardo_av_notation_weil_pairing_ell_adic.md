$\langle \cdot, \cdot \rangle_\ell$ [[lombardo_av_REMARK 10.11|denotes]] the $\ell$-adic Weil pairing for the abelian variety $A/K$ with $\ell$ a prime not equal to $\operatorname{char}(K)$. It is a perfect bilinear pairing
$$
